...
export default function EscarapelaJ({
  item,
  tournament,
  team,
}: {
  ...
  return (
    <>
      <div style={{ width: "100mm", height: "160mm" }} className="flex flex-col justify-start items-center mb-15 bg-blue-500 relative rounded-2xl">
        ...
        <div className="bg-white p-2 rounded-2xl w-[300px] h-[30px] flex items-center mt-5 z-41">
          Fecha de nacimiento: {item.birthYear.split("T")[0]}
        </div>
        <div className="bg-white p-2 rounded-2xl w-[300px] h-[30px] flex items-center mt-5 z-41">
