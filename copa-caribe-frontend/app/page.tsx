...
export default function Home() {
  ...
  const { show, setShow, setRol, device } = useHome();
  ...
  return (
    <>
      ...
      <div className="relative">
        <Image
          className="image-futbol min-h-screen w-auto md:h-auto md:w-full  "
          src={futbol}
          width={300}
          alt="Dos jovenes jugando futbol"
        ></Image>
        <div className="absolute inset-0 bg-gradient-to-l from-red-950/80 via-red-950/60 to-transparent"></div>

        {/* Forma diagonal */}
        <div className="absolute inset-0 bg-red-950/50 clip-diagonal"></div>
        <div className=""></div>
        <div className="absolute inset-0 flex flex-col items-center md:items-end justify-center">
          <div className="flex flex-col justify-center items-center md:items-end mr-20">
           {(device =="desktop" || device =="tablet") && (<h1 className="text-9xl flex ml-5">
              {" "}
              <span className="text-white">Copa</span>{" "}
              <span className="text-white pl-4">Caribe </span>
            </h1>)}
            {(device =="mobile") && ( <><h1 className="text-9xl flex ml-5">
              {" "}
              <span className="text-white">Copa</span>{" "}

            </h1>  <br/> <h1 className="text-9xl flex ml-5"><span className="text-white pl-8">Caribe </span></h1></> )}
          ...
          <p className="text-white ml-5 md:pl-150 md:mr-0 text-sm md:text-lg">
